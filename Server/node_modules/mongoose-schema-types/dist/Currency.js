...
const validate = (value) => {
    ...
    if (typeof value !== "string") {
        throw mongoose.SchemaType.CastError("Currency", `Value is not string: ${value}`);
    }
    if (!CURRENCY_REGEX.test(value)) {
        throw mongoose.SchemaType.CastError("Currency", `Value is not a valid Currency value: ${value}`);
    }
    return value;
};
